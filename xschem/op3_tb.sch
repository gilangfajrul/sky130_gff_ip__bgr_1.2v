...
C {devices/lab_wire.sym} 30 -140 0 0 {name=p1 sig_type=std_logic lab=-}
C {devices/lab_wire.sym} 30 -265 0 0 {name=p2 sig_type=std_logic lab=+}
...
meas ac gain_1000 find vdb(out) at=1000
...
C {op3.sym} 410 -170 0 0 {name=x1}
C {devices/launcher.sym} 590 -180 0 0 {name=h2
descr="View Raw file" 
tclcommand="textwindow $netlist_dir/op3_tb.raw"}
