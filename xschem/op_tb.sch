...
C {devices/vsource.sym} 30 -100 0 0 {name=V3 value="ac 1 sin(0 1 1) dc 0.9"}
...
"
spice_ignore=false}
C {devices/launcher.sym} 595 -225 0 0 {name=h15
descr="Annotate OP" 
...
C {devices/lab_wire.sym} 240 -240 0 0 {name=p3 sig_type=std_logic lab=-}
C {devices/lab_wire.sym} 240 -275 0 0 {name=p4 sig_type=std_logic lab=+}
C {op.sym} 15 -20 0 0 {name=x1}
