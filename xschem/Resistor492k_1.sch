...
C {devices/gnd.sym} 2060 930 0 0 {name=l4 lab=GND}
...
C {devices/iopin.sym} 2050 1135 0 0 {name=p1 lab=B}
...
spiceprefix=X
mult=1}
C {devices/gnd.sym} 1965 1155 0 0 {name=l5 lab=GND}
