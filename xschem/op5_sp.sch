...
C {devices/code.sym} 745 -115 0 0 {name=params only_toplevel=false value="
**************
*PMOS cms
.param L1=20
.param W1=0.5
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1025 -235 3 0 {name=C1 model=cap_mim_m3_1 W=17 L=15 MF=4 spiceprefix=X}
