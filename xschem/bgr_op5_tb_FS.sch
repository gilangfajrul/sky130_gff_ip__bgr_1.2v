...
.endc
"}
C {sky130_fd_pr/corner.sym} 675 -185 0 0 {name=CORNER only_toplevel=false corner=fs}
...
C {devices/launcher.sym} 625 -40 0 0 {name=h1
descr="Annotate OP" 
