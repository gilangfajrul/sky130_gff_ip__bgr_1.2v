...
C {sky130_fd_pr/cap_mim_m3_1.sym} 305 115 1 0 {name=C3 model=cap_mim_m3_1 W=17 L=17 MF=11 spiceprefix=X}
C {devices/iopin.sym} 55 120 2 0 {name=p1 lab=B}
C {devices/iopin.sym} 335 100 3 0 {name=p2 lab=AVSS}
C {devices/lab_pin.sym} 275 100 0 0 {name=p3 sig_type=std_logic lab=AVSS}
