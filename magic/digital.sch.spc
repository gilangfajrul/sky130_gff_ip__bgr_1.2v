...
.subckt digital s3 dvss trim1 trim3 s1 d3 s2 trim0 trim2 s0 svbgsc vdde ena dvdd vbgsc avdd svbgtc vena vbgtc
*.PININFO trim1:B trim0:B dvss:B trim3:B trim2:B vbgsc:B vbgtc:B vena:B avdd:B dvdd:B ena:B dvss:B s3:B d3:B s2:B s0:B s1:B vdde:B
*+ svbgsc:B svbgtc:B
